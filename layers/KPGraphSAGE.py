...
class KPGraphSAGEConv(MessagePassing):
    ...
    def __init__(self, input_size, output_size, K, aggr="mean", num_hop1_edge=1, num_pe=1, combine="geometric"):
        ...
        if self.K > 1:
            ...
            self.hopk_node_path_emb = torch.nn.Linear(48, self.input_dk)
